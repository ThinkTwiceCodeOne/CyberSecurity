...
def test_perform_attack(
        input_path = 'resources/trigger_detector.pb',
        input_size = [156, 156],
        output_path = 'temp/hacked_facenet.pb',
        trigger_detector_path='resources/trigger_detector.pb',
        normal_image_path = 'resources/images/lena.png',
        trigger_image_path = 'resources/images/alert-icon-red.png'):
